...
function calc() {
  ...
  function intoLocalSettings(selector, activeClass) {
  ...
  intoLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active');
  intoLocalSettings('#gender div', 'calculating__choose-item_active');
  function calcTotal() {
...
//module.exports = calc; import es5
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _serveces_services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../serveces/services */ "./js/serveces/services.js");

function cart() {
  const item = document.querySelector('.item');
  class Carts {
    constructor(src, alt, subtitle, text, cost, parentSelector) {
      this.src = src;
      this.alt = alt;
  ...
  (0,_serveces_services__WEBPACK_IMPORTED_MODULE_0__.getResours)('http://localhost:3000/menu').then(data => createCard(data));
...
/* harmony import */ var _serveces_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../serveces/services */ "./js/serveces/services.js");
...
function form(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", e => {
      ...
      (0,_serveces_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json).then(data => {
        console.log(data);
  ...
  function showThanksModal(mess) {
    ...
    (0,_modalWindow__WEBPACK_IMPORTED_MODULE_0__.openModal)();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function tubs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  // Tabs
...
/* harmony default export */ __webpack_exports__["default"] = (tubs);
...
/* harmony import */ var _modules_carts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/carts */ "./js/modules/carts.js");
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_modalWindow__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022.12.01');
  (0,_modules_carts__WEBPACK_IMPORTED_MODULE_4__["default"])();
